document.addEventListener('DOMContentLoaded', () => {
    ...
    const quarter = parseInt(params.get('quarter')) || parseInt(params.get('q')) || 1;
    ...
    async function initSummary() {
        if (!empId) {
            console.error("No Representative ID provided for summary.");
            return;
        }
        ...
        try {
            ...
            // Medrep info
            const displayName = data.medrep?.name || 
